...
bool UMainMenu::Initialize()
{
    ...
    if(!ensure(QuitButtonMainMenu != nullptr)) return false;
    QuitButtonMainMenu->OnClicked.AddDynamic(this, &UMainMenu::QuitPressed);

    if(!ensure(JoinButtonJoinMenu != nullptr)) return false;
    ConfirmHostMenuButton->OnClicked.AddDynamic(this, &UMainMenu::UMainMenu::HostServer);
